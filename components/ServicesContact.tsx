...
const ServicesContact: React.FC = () => {
  return (
    <section className="bg-white py-16 px-6 md:px-20 flex flex-col md:flex-row items-stretch">
      {/* Image Section */}
      <div className="md:w-2/5 hidden md:flex relative bg-cover bg-center" style={{ backgroundImage: "url('/slider3.png')" }}>
      ...
      {/* Form Section */}
      <div className="md:w-3/5  p-2 md:p-16 flex flex-col justify-center">
        <form className="flex flex-col gap-10">
          ...
          <button
            type="submit"
            className="bg-green-100 text-white py-3 px-6 rounded-tl-md rounded-br-md hover:bg-green-500 transition-all font-semibold"
          >
            Envoyer
          </button>
        </form>
